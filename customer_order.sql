...
DROP PROCEDURE IF EXISTS `PR_GET_CUSTOMER_ORDER_V3`$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `PR_GET_CUSTOMER_ORDER_V3`(IN i_seat_no INT,IN i_menu_items VARCHAR(200),IN i_menu_count VARCHAR(50),OUT message VARCHAR(500))
BEGIN
